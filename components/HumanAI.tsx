        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          <div>
            ...
            <p className="font-mono text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
              I focus on understanding the problem, then on the software.
              My approach prioritizes on depth knowledge on the domain, 
              in order to translate it into the code required for the specific need.
            </p>
            <p className="font-mono text-xs sm:text-sm leading-relaxed">
              Every line of code is a trade off. I document those decisions,
              build with testing in mind, and believe that
              turning complexity into simplicity is key.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="font-mono text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4">
              ...
              with documentation, helps explore edge cases, and acts as a rubber
              duck for architecture decisions.
            </p>
            <p className="font-mono text-xs sm:text-sm leading-relaxed">
              But the hard problems: system design, business priorities,
              down to earth judgement, those are handled by me.
            </p>
          </div>
        </div>
      </div>
