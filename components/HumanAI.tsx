  ...
  return (
    ...
    >
      <div className="border-[3px] border-border-brutal bg-background p-12 shadow-[6px_6px_0_0_var(--shadow-color)]">
        <h2 className="font-mono text-4xl uppercase mb-8">THE HUMAN & AI</h2>

        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <h3 className="font-mono text-xl uppercase mb-4 text-gold">
          ...
          <div>
            <h3 className="font-mono text-xl uppercase mb-4 text-neon-green">
